  ...
  return (
    <>
      <h1 className="flex justify-center items-center font-semibold  w-full mt-10 text-center p-5 text-4xl">
        Welcome to x-chat, register below
      </h1>
      <div className="flex justify-center items-center bg-gradient-to-tr from-lime-50 to-sky-700 h-screen font-primary p-10 m-2">
        {/*form*/}
        <form
        ...
        >
          ...
          <div>
            <label className="label">
              <span className="text-base text-black label-text">Name:</span>
            </label>
            <input
              type="text"
              placeholder="Name"
