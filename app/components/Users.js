...
const logoutClick = () => {
  ...
  return (
    <div className='shadow-lg h-screen overflow-auto mt-4 mb-20'>
      <div className="flex flex-col lg:flex-row justify-between bg-black p-4 space-y-4 lg:space-y-0">
        <button
      ...
      <div>
        {activeTab === 'chatrooms' && (
          <>
            <h1 className='px-4 text-base text-black font-semibold mt-3'>Chatrooms</h1>
            {
              loading && (
        ...
        {activeTab === 'users' && (
          <>
            <h1 className='mt-4 px-4 text-base text-black font-semibold'>Users</h1>
            {
              loading2 && (
                <div className="flex justify-center items-center h-full">
                  <span className="loading loading-spinner text-primary"></span>
            ...
            {
              users.map((user) => (
                <div className="text-black" key={user.id} onClick={()=>{createChat(user)}}>
                 {user.id !== userData?.id &&
                <UsersCard
                  name={user.name}
